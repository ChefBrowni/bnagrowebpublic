  ...
  <section id="process" class="py-5 bg-light">
    ...
    <div class="col-12 col-lg-6">
      <div class="ratio ratio-4x3">                 <!-- <<< FIX 4:3 ARÁNY -->
        <img src="images/folyamat_abra.svg"
             class="object-contain w-100 h-100"     <!-- teljes tartalom látszik -->
             alt="Lépések infografika">
      </div>
    </div>

    <div class="col-12 col-lg-6">
      <div class="ratio ratio-4x3">
        <img src="images/dron_allo.jpg"
             class="object-cover w-100 h-100"       <!-- látványos kitöltés -->
             alt="Drón permetezés közben">
      </div>
    </div>
  </div>
